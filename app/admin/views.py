# coding:utf-8
import sys
# Python 3中不需要reload(sys)和setdefaultencoding

from datetime import datetime
import json
from flask import render_template, redirect, flash, \
    url_for, request, jsonify, send_from_directory, current_app
import os
...
def manage_articles():
    ...
    if form.validate_on_submit() or \
        ...
        pagination_search = result.paginate(
                page=page, per_page=current_app.config['ARTICLES_PER_PAGE'], error_out=False)
